...
export class ItinerarydetailsComponent implements OnInit {
  ...
  constructor(private itDetailsService: ItinerarydetailsService,private apiService: ApiService,private formBuilder: FormBuilder,  private data: DataCountsService) {
    this.createForm();
  }
