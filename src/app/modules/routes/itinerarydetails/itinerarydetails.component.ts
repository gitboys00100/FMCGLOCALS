...
// ------------------------------ FOR MODAL ---------------------------
  public onUpdateItineraryOpen(value: string) {
    ...
    for(var x =0;x<this.itineraryDetails.length;x++) {
      if(temp[x].id == value) {
        ...
        this.selectedRetailers = temp[x].retailers;
        this.tempSelectedRetailers = temp[x].retailers;
      }
    }
  ...
  public onUpdateItineraryClose() {
    this.selectedRetailers = this.tempSelectedRetailers;
