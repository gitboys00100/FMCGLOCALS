...
//category uom, subcat size
        ...
        for (const item of inventoryItems) {
            ...
            if (category !== '' && subCategory !== '' && filterDate !== '') {
                if (this.cleanedStr(item.uom) === this.cleanedStr(category) &&
                    this.cleanedStr(item.size) === this.cleanedStr(subCategory) &&
                ...
                if (this.cleanedStr(item.size) === this.cleanedStr(subCategory) &&
                    this.cleanedStr(newDate) === this.cleanedStr(filterDate)) {
                    if (!this.checkIfExists(item, resultArray))
                        resultArray.push(item);
                }
