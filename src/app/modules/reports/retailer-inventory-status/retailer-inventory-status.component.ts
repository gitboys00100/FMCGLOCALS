...
export class RetailerInventoryStatusComponent implements OnInit {
  ...
  ngOnInit() {
    this.headers = ["Region/State","Cluster","Township","Agent","Retailer","SKU","Inventory"];
  ...
  showSalesTable() {
    ...
    if (this.retailerInventoryForm.invalid) {
      ...
      var param_region = this.removeNull(this.retailerInventoryForm.get('region').value);
      var param_cluster = this.removeNull(this.retailerInventoryForm.get('cluster').value);
      var param_township = this.removeNull(this.retailerInventoryForm.get('township').value);

      var param_agent = this.removeNull(this.retailerInventoryForm.get('agent').value);
      var param_retailer = this.removeNull(this.retailerInventoryForm.get('retailer').value);
