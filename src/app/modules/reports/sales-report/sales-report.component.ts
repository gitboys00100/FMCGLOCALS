...
export class SalesReportComponent implements OnInit {
  ...
  showSalesTable() {
    ...
    if (this.salesReportForm.invalid) {
      ...
      var param_region = this.salesReportForm.get('region').value;
      var param_cluster = this.salesReportForm.get('cluster').value;
      var param_township = this.salesReportForm.get('township').value;

      var param_agent = this.salesReportForm.get('agent').value;
      var param_retailer = this.salesReportForm.get('retailer').value;
      var param_sched = this.salesReportForm.get('sched').value;
      var param_from_date, param_to_date, specific_date, params;

      if(param_sched != 'monthly') {
        param_from_date = this.salesReportForm.get('from_date').value;
        param_to_date = this.salesReportForm.get('to_date').value;
        ...
        specific_date = this.salesReportForm.get('specific_date').value;
