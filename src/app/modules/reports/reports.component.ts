...
export class ReportsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    else if(this.router.url == '/reports/accounts-receivable') {
      this.selectedReport = 'Accounts Receivable Report';
    }
    this.reports = [
      {
  ...
  setSelectedReport(selected: string) {
    ...
    else if(selected == 'Accounts Receivable Report') {
      this.routerNavigate("/reports/accounts-receivable");
    }
