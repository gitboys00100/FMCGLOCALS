...
export class AnnouncementComponent implements OnInit {
  ...
  get f() {
    //console.log(this.newAnnouncementForm.controls);
  ...
  submitAnnouncementForm() {
    ...
    if(this.selectedType == 'new_product') {
      let item = this.newAnnouncementForm.get('item').value;
      a_announcement['item_id'] = item;
    }
    ...
    if(a_type == 'promos') {
      ...
      a_announcement['item_name'] = this.newAnnouncementForm.get('item').value;
    }
    ...
    //console.log(announcement_json_string);
  ...
  clickFrom(date){
    this.from_date = date;
    let control = this.newAnnouncementForm.get('end');
  ...
  checkDates(date){
    ...
    if(this.from_date <= this.to_date){
      ...
      this.newAnnouncementForm.get('end').setValue('');
    }
  }
